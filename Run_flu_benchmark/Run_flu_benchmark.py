...
# # from library import read_gmt
# # from dataprocess import preprocess_signature
# # from benchmarking import benchmark_parallel
# # from HVGs import entropy2gene, HVGs, entropy_HVGs
from grea import GREA, read_gmt,preprocess_signature,benchmark_parallel,entropy2gene, HVGs, entropy_HVGs

data_list = [
    {
        "dataset_name": "GSE52428_H1N1",
        "path": "DATA/FLU_Data/GSE52428_H1N1",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE52428_H3N2",
        "path": "DATA/FLU_Data/GSE52428_H3N2",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_H1N1_DEE3",
        "path": "DATA/FLU_Data/GSE73072_H1N1_DEE3",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_H1N1_DEE4",
        "path": "DATA/FLU_Data/GSE73072_H1N1_DEE4",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_H3N2_DEE2",
        "path": "DATA/FLU_Data/GSE73072_H3N2_DEE2",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_H3N2_DEE5",
        "path": "DATA/FLU_Data/GSE73072_H3N2_DEE5",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_HRV_DUKE",
        "path": "DATA/FLU_Data/GSE73072_HRV_DUKE",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_HRV_UVA",
        "path": "DATA/FLU_Data/GSE73072_HRV_UVA",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    },
    {
        "dataset_name": "GSE73072_RSV_DEE1",
        "path": "DATA/FLU_Data/GSE73072_RSV_DEE1",
        "group": "symptom",
        "sample_name": "SampleID",
        "perturbation": "Symptomatic",
    }
...
def run_entropy_5000_FC_benchmark(data_list, library_path,output_dir="result"):
    ...
    for data_obj in data_list:
        ...
        benchmark_parallel(signature=sub_signature_5000_FC, library=library,output_dir=f"{output_dir}/{dataset_name}",methods = ['grea_KS_signperm_es', 'grea_KS_signgamma_es', 'grea_KS_signperm_esd', 'grea_KS_signgamma_esd', 'grea_RC_perm_AUC', 'grea_RC_gamma_auc'],rep_n = 3, perm_list = [500,1000,2000])  
...
run_entropy_5000_sg_FC_benchmark(data_list,library_path="DATA/Enrichr.KEGG_2021_Human.gmt",output_dir="result_entropy_5000_sg_logfc")
...
run_exp_5000_FC_benchmark(data_list,library_path="DATA/Enrichr.KEGG_2021_Human.gmt",output_dir="result_exp_5000_logfc")
...
run_entropy_5000_FC_sg_benchmark(data_list,library_path="DATA/Enrichr.KEGG_2021_Human.gmt",output_dir="result_entropy_5000_FC_sg")
...
run_entropy_sg_5000_FC_benchmark(data_list,library_path="DATA/Enrichr.KEGG_2021_Human.gmt",output_dir="result_entropy_sg_5000_FC")
...
align_entropy_sg_FC_benchmark(data_list,library_path="DATA/Enrichr.KEGG_2021_Human.gmt",output_dir="align_entropy_sg_FC")
